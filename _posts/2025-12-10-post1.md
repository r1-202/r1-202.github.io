...
are CPUs' close nighbours that started out as optimizations of CPUs more suitable to 
graphical applications. GPUs are now transforming the way we compute especially with the rising 
popularity of AI and the need for more parallelism, but the G in GPUs will always stand for Graphics.
